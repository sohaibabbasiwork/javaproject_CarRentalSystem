...
public class CustomersLogs  extends JFrame implements ActionListener{
	...
	CustomersLogs() throws SQLException{
	...
	public void actionPerformed(ActionEvent ae) {
		 ...
		 if(ae.getSource()==b2) {
			...
			this.setVisible(false);	
              ...
              String qre= String.format("select name, gender,country, vehicleno,deposit,email,contactno,number,date from customer");
