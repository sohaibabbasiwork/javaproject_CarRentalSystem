...
public class UpdateEmployee extends JFrame implements ActionListener{
	...
	UpdateEmployee(){
		...
		JLabel l2 = new JLabel("Employ Email");		
		...
		if(ae.getSource()==b2) {
			...
			try {
				...
				String id = c1.getSelectedItem();			
                 ...
                 String str2 = "update  employee set name = '"+t1.getText()+"',age = '"+t2.getText()+"',salary = '"+t3.getText()+"',phone = '"+t4.getText()+"',cnic = '"+t5.getText()+"' where email = '"+id+"'";
		 ...
		 c.s.executeUpdate(str2);
	         JOptionPane.showMessageDialog(null, "Employee Updated successfully");	 
				...
				System.out.println(e);
                    ...
                    try{
                        conn c = new conn();
                 String str = "select * from employee where email = '"+c1.getSelectedItem()+"'";
